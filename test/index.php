...
$gv = new GoogleVoice('sunnyrajkum@gmail.com', 'passwrd');

// Call a phone from one of your forwarding phones.
$gv->callNumber('8010490862', '5558675309', 'mobile');

// Cancel in-progress call placed using callNumber.
$gv->cancelCall('8010490862', '5558675309', 'mobile');

// Send an SMS to a phone number.
$gv->sendSMS('8010490862', 'Sending a message!');
